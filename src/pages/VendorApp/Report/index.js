...
const Report = () => {
    ...
    const series1 = [{
        name: 'Users',
        data: [30000, 40000, 45000, 50000, 49000, 60000, 70000, 91000, 50000, 49000, 60000, 70000, 91000, 40000, 45000, 50000, 49000, 60000, 91000, 50000, 49000, 60000, 70000, 91000, 45000, 50000, 49000, 60000, 70000, 91000]
    }, {
        name: 'Revenue',
        data: [91000, 80000, 70000, 79000, 70000, 85000, 91000, 70000, 60000, 79000, 70000, 91000, 80000, 99000, 70000, 75000, 80000, 91000, 80000, 83000, 79000, 80000, 91000, 70000, 90000, 89000, 90000, 85000, 78000, 80000]
    }]
            ...
            <Row gutter={0} className="sectionRow">
                <Col span={24}>
                    <StatsCard 
                        ...
                        hasDateFilter={true}
                    >
                        <div className="" style={{ padding: '0px 32px', marginTop: '25px'}}>
                                        ...
                                        return (
                                            <Col span={6}>
                                                <div className="cardView">
                                                    <p className="name">{name}</p>
                                                    <h4>{index < 2 && 'NGN'} {value.toLocaleString()}</h4>
                                                </div>
                                            </Col>
                                        )
                                    })
            ...
            <Row gutter={18} className="sectionRow">
                <Col span={12}>
                    <StatsCard 
                        title="Customer"
                    >
                        <Row gutter={110} justify="center" align="middle" className="" style={{ padding: '0px 32px', marginTop: '25px'}}>
                            <Col span={12}>
                                <Chart 
                                        ...
                                        customerChartData.series.map((value, index) => {
                                            ...
                                            return (
                                                <div className="donutLegendItem">
                                                    <p><span className="dot greenDot" style={{background: color}}></span> {value.toLocaleString()} (35%)</p>
                                                    <span>{label}</span>
                                                </div>
                                            )
                                        })
                ...
                <Col span={12}>
                    <StatsCard 
                        title="Terminals"
                    >
                        <Row gutter={110} justify="center" align="middle" className="" style={{ padding: '0px 32px', margin: '25px 0px'}}>
                            <Col span={12}>
                                <Chart 
                ...
                <Col span={24}>
                    ...
                    >
                        <div className="" style={{ padding: '0px 32px', marginTop: '25px'}}>
                            <Row gutter={38} className="cardsRow">
                                <Col span={6}>
                                    <img src={CarImg} alt="car" style={{ marginTop: '20px', marginBottom: '20px' }} />
                                </Col>
                                <Col span={9}>
                                    <Row>
                                        <Col span={8}>
                                            <Progress type="circle" percent={75} width="100px" strokeWidth="8" strokeColor="#FFBC00" trailColor="#FADE90" />
                                        </Col>
                                        <Col span={16}>
                                            <span>Available</span>
                                ...
                                <Col span={9} className="textCenter">
                ...
                <Col span={24}>
                    ...
                    >
                        <div className="" style={{ padding: '0px 32px', marginTop: '25px'}}>
                            <Row gutter={38} className="cardsRow">
                                {
                                    monthlyRefundData.map(({ name, value }) => {
                                        return (
                                            <Col span={6}>
                                                <div className="cardView">
                                                    <p className="name">{name}</p>
                    ...
                    >
                        <div className="mostStats" style={{ padding: '21px 16px'}}>
                            ...
                            <div>
                                <>
                                    <h3>MYZIPULIVE</h3>
                                    <p>20% valid for 5 days <br/> 12 terminals selected</p>
                                </>
                            </div>
                            <Link to="/reports/promo-codes"> <span className="badge">Rewards/promo settings</span> </Link>
                        </div>
                    </StatsCard>
                </Col>
            </Row>
