  ...
  return (
    <div className="tripPackagesWrapper">
      <div className="tripPackageLeft">
        <h1>Top trip packages</h1>
        <p>A valet is usually an employee of the establishment or an employee of a third party</p>
        <div className="directionArrowsWrapper">
          <img src={LeftDirectionIcon} alt="LeftDirectionIcon" onClick={() => onScrollLeft(-40)} />
          <img src={RightDirectionIcon} alt="RightDirectionIcon" onClick={() => onScrollRight(40)} />
        </div>
      </div>
              ...
              tripPackage.map((tripPackage) => {
                return (
                  <React.Fragment key={tripPackage.id}>
                    <TripPackageCard tripPackage={tripPackage} position={position} />
                  </React.Fragment>
                )
              })
            }
