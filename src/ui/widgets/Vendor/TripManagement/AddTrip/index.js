...
// import { createTrip, fetchAllTrips } from '../../../../redux/actions/trips/trips.actions';
...
// 			<Form form={form} onFinish={handleCreateTrip} hideRequiredMark layout="vertical">
// 				<div className="main">
// 					<Row gutter={0}>
// 						<Col span={12}>
...
// 											hasFeedback
// 											validateTrigger={['onChange', 'onBlur']}
// 											rules={[{ required: true, message: 'Please enter the trip class' }]}>
...
// 											hasFeedback
// 											validateTrigger={['onChange', 'onBlur']}
// 											rules={[{ required: true, message: 'Please enter the trip date and time' }]}>
// 											<DatePicker
// 												style={{ width: '100%' }}
...
// 											hasFeedback
// 											validateTrigger={['onChange', 'onBlur']}
// 											rules={[{ required: true, message: 'Please enter the start terminal' }]}>
// 											<Select
// 												placeholder="Select start terminal"
// 												onChange={(value) => setStartTerminal(value)}>
// 												{terminals
// 													.filter(({ id }) => id !== endTerminal)
// 													.map(({ id, name }, index) => {
// 														return <Select.Option key={id}>{name}</Select.Option>;
// 													})}
// 												<Select.Option key={1}>DEFAULT</Select.Option>
...
// 											hasFeedback
// 											validateTrigger={['onChange', 'onBlur']}
// 											rules={[{ required: true, message: 'Please enter the end terminal' }]}>
// 											<Select
// 												placeholder="Select end terminal"
// 												onChange={(value) => setEndTerminal(value)}>
// 												{terminals
// 													.filter(({ id }) => id !== startTerminal)
// 													.map(({ id, name }, index) => {
// 														return <Select.Option key={id}>{name}</Select.Option>;
// 													})}
// 												<Select.Option key={1}>DEFAULT</Select.Option>
...
// 						</Col>
// 						<Col span={12}>
// 							<Card className="promoHistory" style={{ height: '100%' }}></Card>
// 						</Col>
// 					</Row>
// 				</div>
// 			</Form>
